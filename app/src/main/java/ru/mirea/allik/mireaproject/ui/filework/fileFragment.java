package ru.mirea.allik.mireaproject.ui.filework;
...
import ru.mirea.allik.mireaproject.databinding.FragmentFileBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.encryptBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String line = String.valueOf(binding.masEdit.getText());
                Intent intent = new Intent(mContext, encryptionActivity.class);
